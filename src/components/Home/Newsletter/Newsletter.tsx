...
const Newsletter = () => {
	return (
		<div className="bg-black pt-16 pb-16 flex flex-col items-center justify-center w-full ">
			...
			<h1 className="text-lg sm:text-lg md:text-2xl text-white font-semibold mt-10 -tracking-widest">
			...
			<div className="w-full">
				<input
					...
					placeholder="Email"
				/>
				<button className="px-6 py-3.5 bg-blue-900 hover:bg-blue-950 text-white transition-all duration-200 mt-3 w-[95%] sm:w-[80%] md:w-[60%] lg:w-[40%] block mx-auto rounded-lg outline-none">
					Subscribe
				</button>
			</div>
		</div>
